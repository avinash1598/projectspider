...
public class RtspClient {
    ...
    public RtspClient() {
        ...
        new HandlerThread("com.example.avinash.screen.RtspClient"){
            @Override
    ...
    public void startStream() {
        ...
        mHandler.post(new Runnable () {
            ...
            public void run() {
                ...
                try {Log.d("strted","after connection");
                    mParameters.session.syncStart(1);
    ...
    private void sendRequestAnnounce() throws IllegalStateException, SocketException, IOException {
        ...
        String body = mParameters.session.getSessionDescription();//////////session in use//////////////////////
